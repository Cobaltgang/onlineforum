...
public static function createCookie($username, $user_id, $token, $serial){
    setcookie('username', $username, time() + (86400) *10, "/", null, true, true);
    setcookie('session_userid', $user_id, time() + (86400) *10, "/", null, true, true);
    setcookie('token', $token, time() + (86400) *10, "/", null, true, true);
    setcookie('serial', $serial, time() + (86400) *10, "/", null, true, true);
}
